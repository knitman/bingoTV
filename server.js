...
let tickets = {};
let expectedPlayersCount = 0; // πόσα ονόματα μπήκαν στο bulk panel
...
app.get("/api/draw", (req, res) => {
  ...
  if (!running) {
    return res.json({ error: "Game not running" });
  }
...
/** Start game (θα καλείται από την TV μετά το countdown) */
